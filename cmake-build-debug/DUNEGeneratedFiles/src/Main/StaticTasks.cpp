...
DUNE::Tasks::Task* createManeuverFollowSystemOtterTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createManeuvertest_taskTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createSimulatorsEvoSimulatorTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Factory::registerStaticTask("Maneuver.FollowSystemOtter", createManeuverFollowSystemOtterTask);
...
DUNE::Tasks::Factory::registerStaticTask("Maneuver.test_task", createManeuvertest_taskTask);
...
DUNE::Tasks::Factory::registerStaticTask("Simulators.EvoSimulator", createSimulatorsEvoSimulatorTask);
